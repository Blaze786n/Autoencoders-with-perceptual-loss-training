...
sys.path.append("F:/ML PROJECT LAB NEW/Image_Transfer_Scripts")
from server_encoder import Encoder
from client_decoder import Decoder
...
encoder.load_state_dict(torch.load("F:/ML PROJECT LAB NEW/Image_Transfer_Scripts/encoder_custom.pth", map_location=device))
decoder.load_state_dict(torch.load("F:/ML PROJECT LAB NEW/Image_Transfer_Scripts/decoder_custom.pth", map_location=device))
encoder.eval()
decoder.eval()
